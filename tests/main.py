...
key="INSERT YOUR OBSERVER API KEY HERE" #Observer API Key

async def main():
    client = await Observer(key=key) #define the client
    ...
    player_ranking = await client.ranking.get("b876ec32e396476ba1158438d83c67d4", "alltime", "bedwars", "wins")
    print(player_ranking.rank)
    ...
    daily = await client.daily.get("b876ec32e396476ba1158438d83c67d4")
    print(daily.bedwars.wins)
